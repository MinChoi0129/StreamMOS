...
c. If you want to reproduce the results of the paper, we provide a pre-trained model on [OneDrive](https://1drv.ms/f/c/ce3e6ec833cb3fde/Ej5UgSeiA4JEi-SFqOOotYgB1Vnw4kIuZNgGIqo6XudMRw?e=NMr7Sp). You need to place the folder named `StreamMOS_seg` in `experiments/`.
```
