...
class SequenceCutPaste:
    ...
    def paste_single_obj(self, pcds_list, pcds_label_list, pcds_bf_label_list, pcds_road_list, pcds_raw_label_list):
        '''
        Input:
        ...
        if(len(pc_object_list[0][0]) < 10):
            return pcds_list, pcds_label_list, pcds_bf_label_list, pcds_raw_label_list
        ...
        for theta in theta_list:
            ...
            if valid_flag:
                ...
                for ht in range(len(pc_object_aug_list)):
                    ...
                    pcds_bf_label_filter_ht = pcds_bf_label_list[ht][~fov_mask]
                    ...
                    pcds_addobj_bf_label_ht = np.full((pcds_obj_aug_ht.shape[0],), fill_value=2, dtype=pcds_bf_label_filter_ht.dtype)
                    ...
                    pcds_bf_label_list[ht] = np.concatenate((pcds_bf_label_filter_ht, pcds_addobj_bf_label_ht), axis=0)
    ...
    def __call__(self, pcds_list, pcds_label_list, pcds_bf_label_list, pcds_road_list, pcds_raw_label_list):
        paste_obj_num = random.randint(0, self.paste_max_obj_num)
        if paste_obj_num == 0:
            return pcds_list, pcds_label_list, pcds_bf_label_list
        else:
            for i in range(paste_obj_num):
                pcds_list, pcds_label_list, pcds_bf_label_list, pcds_raw_label_list = self.paste_single_obj(pcds_list, pcds_label_list, pcds_bf_label_list, pcds_road_list, pcds_raw_label_list)
