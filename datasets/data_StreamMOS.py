...
class DataloadTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pc_list_all, pc_label_list_all, pc_road_list_all, pc_raw_label_list_all = self.form_seq(meta_list_raw)

        # copy-paste
        if self.cp_aug is not None:
            pc_list_all, pc_label_list_all = self.cp_aug(pc_list_all, pc_label_list_all, pc_road_list_all, pc_raw_label_list_all)
